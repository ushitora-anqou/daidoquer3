...
export async function usefulReplyOrFollowUp (interaction:  CommandInteraction<CacheType>, options: string | MessagePayload | InteractionReplyOptions): Promise<void> {
